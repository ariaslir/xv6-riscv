...
extern uint64 sys_syscalltrace(void); // defined syscalltrace
...
static uint64 (*syscalls[])(void) = {
  ...
  [SYS_close]   = sys_close,
  [SYS_sync]    = sys_sync,
  [SYS_syscalltrace] = sys_syscalltrace, // added syscalltrace to array of syscalls
  // clang-format on
};
// added in this array to store names and output the names
static const char *syscall_names[] =  {
  ...
  [SYS_close]   = "close",
  [SYS_sync]    = "sync",
  [SYS_syscalltrace] = "syscalltrace", // added syscalltrace to array of syscalls
  // clang-format on
};
